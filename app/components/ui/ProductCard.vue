<template>
  ...
  >
    ...
    <NuxtLink :to="`/products/${product.slug || product._id}`">
      ...
      >
        ...
        <div class="absolute top-3 left-3 flex flex-col items-start gap-2">
          ...
          <span
            class="bg-error/70 rounded-full px-2 py-1 text-xs font-medium text-white backdrop-blur-sm"
    ...
    <!-- Product Info -->
    <div class="p-4">
      <h3 class="mb-2 line-clamp-2 text-start text-sm leading-tight font-bold text-gray-900">
        <NuxtLink
      ...
      <div class="flex items-center justify-between">
        ...
        <span
          ...
          @click="navigateTo(`/products/${product.slug || product._id}`)"
        >
          View
