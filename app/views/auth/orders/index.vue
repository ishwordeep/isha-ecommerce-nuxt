<template>
  <div class="space-y-4">
    ...
    <template v-else-if="!state.fetching && orderStore.orders?.length">
      <div
...
const statusOptions = computed(() => [
  {
    ...
    label: 'Pending',
    icon: 'i-lucide-clock',
    count: orderStore.statusCounts?.PENDING_PAYMENT || 0,
  },
  {
    value: 'paid',
    label: 'Paid',
    icon: 'i-lucide-credit-card',
    count: orderStore.statusCounts?.PAID || 0,
  },
  {
    value: 'shipped',
    label: 'Shipped',
    icon: 'i-lucide-truck',
    count: orderStore.statusCounts?.SHIPPED || 0,
  },
  {
    value: 'completed',
    label: 'Completed',
    icon: 'i-lucide-check-circle',
    count: orderStore.statusCounts?.COMPLETED || 0,
  },
  {
    value: 'cancelled',
    label: 'Cancelled',
    icon: 'i-lucide-x-circle',
    count: orderStore.statusCounts?.CANCELLED || 0,
  },
])
